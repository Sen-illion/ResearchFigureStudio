...
- `rfs/control_localizer.py`、`rfs/layout_planner.py`、`rfs/layout_semantic_planner.py`：rebuild-editable 使用的控件定位、布局规划和语义规划模块，支持 heuristic/VLM/hybrid。
...
`rebuild-editable` 还会写出 `rebuild_result.json`、`asset_generation_specs.json`、`asset_generation_report.json`、`asset_economy_report.json`、`asset_ratio_fit_report.json`、`slot_semantic_report.json`、`rebuild_vlm_validation_report.json`、`reference_geometry_overlay.png`、`reference_controls_overlay.png` 等重建专用 artifact。
